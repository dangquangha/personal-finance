...
var DASHBOARD = {
  ...
  buildChartByMonths: function buildChartByMonths() {
    var ctx = document.getElementById('chart-by-months');
  ...
  buildChartByBudgets: function buildChartByBudgets() {
    var ctx = document.getElementById('chart-by-budgets');
    var data = {
