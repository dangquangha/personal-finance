...
class JsonResponseBuilder
{
     ...
     */
    const DEFAULT_API_CODE_OK = HttpResponse::HTTP_OK;
     ...
     */
    public static function success($data = null, $message = null, $api_code = null, array $lang_args = null, $http_code = null, $encoding_options = null)
    {
        if ($api_code === null) {
            $api_code = static::DEFAULT_API_CODE_OK;
        }

        return static::buildSuccessResponse($data, $api_code, $lang_args, $http_code, $encoding_options, $message);
    }
     ...
     *
     */
    protected static function buildSuccessResponse($data = null, $api_code = null, array $lang_args = null, $http_code = null, $encoding_options = null, $message = null)
    {
        if ($http_code === null) {
        ...
        return static::make(true, $api_code, $message, $data, $http_code, $lang_args, null, $encoding_options);
    }
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public static function error($api_code, $data = null, $http_code = null, $encoding_options = null, array $lang_args = null)
    {
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public static function errorWithMessageAndDataAndDebug(
        $api_code,
        $error_message,
        $data,
        $http_code = null,
     ...
     */
    protected static function buildErrorResponse(
        $data,
        $api_code,
        $http_code,
        $lang_args = null,
